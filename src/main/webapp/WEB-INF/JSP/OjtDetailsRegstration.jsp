...
<div class="container">
    <div class ="jumbotron"> <center><h1>Student On The Job Training Registration Form</h1></center></div>
    <!- we used the modelAttribute pass value view to controler->
    <sform:form method="post" id="ojtstudentform" modelAttribute="ojtDetails">
        ...
        <div class="row">
            <div class="form-group col-md-12">
                ...
                <label class="col-md-3 control-lable" for="ojtid">Ojt Place </label>
                <div class="col-md-9">
                    <sform:select path="ojtid" items="${ojtList}" multiple="false" itemValue="id"

                                  itemLabel="name" class="form-control input-sm" />
                    <div class="has-error">
                        <sform:errors path="ojtid" class="help-inline"/>
                    </div>
        ...
        <div class="row">
            <div class="form-group col-md-12">
                <label class="col-md-3 control-lable" for="completionDate">Date of completion</label>
                <div class="col-md-9">
                    <sform:input type="date" path="completionDate" id="doj"
                                 class="form-control input-sm"></sform:input>
                    <div class="has-error">
                        <sform:errors path="completionDate" class="help-inline"/>
                    </div>
                </div>
            </div>
        </div>
    ...
    $( document ).ready(function() {
        ...
        $("#submitbutton,#updatesubmit").click(function(event){
            ...
            if(status){
                ...
                $("#ojtstudentform").unbind('submit').submit();
            }
