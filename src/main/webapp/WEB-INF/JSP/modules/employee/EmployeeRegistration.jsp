    ...
    <div class="row">
        ...
        <div class="row">
            <div class="form-group col-md-12">
                ...
                <label class="col-md-3 control-lable" for="employeeTypeId">Employee Type</label>
                <div class="col-md-9">

                    <sform:select path="employeeTypeId" items="${employeeTypeList}" multiple="false" itemValue="id"

                                  itemLabel="name" class="form-control input-sm" />

                    <div class="has-error">
                        <sform:errors path="employeeTypeId" class="help-inline"/>
                    </div>
