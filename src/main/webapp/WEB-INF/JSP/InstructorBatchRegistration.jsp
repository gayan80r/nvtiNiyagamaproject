...
<div class="container">
    <div class ="jumbotron"> <center><h1>Instructor Batch Registration Form</h1></center></div>
    <!- we used the modelAttribute pass value view to controler->
    <sform:form method="post" id="instructorbatchform" modelAttribute="instructorBatch">
        ...
        <div class="row">
            <div class="form-group col-md-12">
                ...
                <label class="col-md-3 control-lable" for="employeid">Instructor Name</label>
                <div class="col-md-9">
                    <sform:select path="employeid" items="${emptList}" multiple="false" itemValue="id"

                                  itemLabel="name_with_initial" class="form-control input-sm" />
                    <div class="has-error">
                        <sform:errors path="employeid" class="help-inline"/>
                    </div>
        ...
        <div class="row">
            <div class="form-group col-md-12">
                <label class="col-md-3 control-lable" for="dateassign">Date Assign</label>
                <div class="col-md-9">
                    <sform:input type="date" path="dateassign" id="doa"
                                 class="form-control input-sm"></sform:input>
                    <div class="has-error">
                        <sform:errors path="dateassign" class="help-inline"/>
                    </div>
                </div>
            </div>
        </div>
    ...
    $( document ).ready(function() {
        ...
        $("#submitbutton,#updatesubmit").click(function(event){
            ...
            if(status){
                ...
                $("#instructorbatchform").unbind('submit').submit();
            }
