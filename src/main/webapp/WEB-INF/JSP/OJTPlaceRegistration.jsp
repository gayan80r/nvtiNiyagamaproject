...
<div class="container">
    <div class="jumbotron">
        <center><h1>OJT Place Registration Form</h1></center>
    </div>
    <!- we used the modelAttribute pass value view to controler->
    <sform:form method="post" id="ojtplaceform" modelAttribute="ojtPlace">

        <div class="row">
            <div class="form-group col-md-12">
                <label class="col-md-3 control-lable" for="name">OJT Place Name</label>
                <div class="col-md-9">
        ...
        <div class="row">
            <div class="form-group col-md-12">
                ...
                <div class="col-md-9">
                    <sform:input type="text" path="landline" id="landline"
                                 class="form-control input-sm"></sform:input>
                    <div class="has-error">
                        <sform:errors path="landline" class="help-inline"/>
                    </div>
                </div>
            </div>
        </div>
    ...
    $(document).ready(function () {
        ...
        $("#submitbutton,#updatesubmit").click(function (event) {
            ...
            if (status) {
                ...
                $("#ojtplaceform").unbind('submit').submit();
            }
        });
